...
def main():
    os.system("bash organize_files.sh Sep2023_more") 
    ...
    for scantype in scantypes:
        if scantype != "mri":
            ...
            df=pd.read_csv("/project/wolk/ADNI2018/scripts/adni_processing_pipeline/testing/mri_processing_status_test_20230911.csv")
            # print(df.head())
            ...
            all_filelocs.to_csv("/project/wolk/ADNI2018/scripts/adni_processing_pipeline/testing/mri_filelocations_20230911.csv",index=False,header=True)
