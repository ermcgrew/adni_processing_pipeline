...
# adni_data_dir = "/project/wolk/ADNI2018/scripts/pipeline_test_data/necktrim_trimtestants_ashsroot_lxie_1"  
# adni_data_dir = "/project/wolk/ADNI2018/scripts/pipeline_test_data/necktrim_trimtestants_ashsroot_lxie_2"  
# adni_data_dir = "/project/wolk/ADNI2018/scripts/pipeline_test_data/necktrim_trimtestants_ashsroot_lxie_3"  
...
this_output_dir = f"{adni_data_dir}/{current_date}"

if not os.path.exists(this_output_dir):
    os.system(f"mkdir -p {this_output_dir}")
if not os.path.exists(stats_output_dir):
    os.system(f"mkdir -p {stats_output_dir}")
