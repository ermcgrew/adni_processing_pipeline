...
for side in left right; do
  ...
  echo c3d $cleanup_seg $t2tau -interp NN -reslice-identity $cleanup_seg -lstat 
  echo c3d $cleanup_seg $t2amy -interp NN -reslice-identity $cleanup_seg -lstat 
  ...
  # echo c3d $wholebrainseg -as SEG -thresh 38 38 1 0 -erode 1 2x2x2vox -popas A \
  ...
  # statline="$statline\t $THISVOL\t $THISNSLICE\t$THISTAU\t$THISAMY"
  done
