...
# cleanup/seg_left cleanup/seg_right cleanup/seg_both t1trim mode
...
statline="$id"
thick=$(c3d $cleanup_left -info-full | grep Spacing | sed -e "s/[a-zA-Z:,]//g" -e "s/\]//" -e "s/\[//" | awk '{print $3}')
...
for side in left right; do
  ...
  c3d $wbseg -as SEG -thresh 38 38 1 0 -erode 1 2x2x2vox -popas A \
  ...
  c3d $wbseg -as SEG -thresh 38 38 1 0 -popas A \
  ...
  # Occipital ROIs
  c3d $wbseg -replace 128 1000 129 1000 144 1000 145 1000 156 1000 157 1000 160 1000 161 1000 -thresh 1000 1000 1 0 -as A $t1tau -interp NN -reslice-identity -push A  -lstat > $TMPDIR/stattauocc.txt
  c3d $wbseg -replace 128 1000 129 1000 144 1000 145 1000 156 1000 157 1000 160 1000 161 1000 -thresh 1000 1000 1 0 -as A $t1amy -interp NN -reslice-identity -push A  -lstat > $TMPDIR/statamyocc.txt
  # Posterior Cingulate ROIs
  c3d $wbseg -replace 166 1000 167 1000 -thresh 1000 1000 1 0 -as A $t1tau -interp NN -reslice-identity -push A  -lstat > $TMPDIR/stattaupc.txt
  c3d $wbseg -replace 166 1000 167 1000 -thresh 1000 1000 1 0 -as A $t1amy -interp NN -reslice-identity -push A  -lstat > $TMPDIR/statamypc.txt
  ...
  c3d $wbseg -popas A $(for roi in 132 133 154 155 200 201 198 199 108 109 106 107 190 191; do echo "-push A -thresh $roi $roi $roi 0" ; done) \
  ...
  # All ROIs tau
  c3d $wbseg -as A $t1tau -interp NN -reslice-identity -push A  -lstat > $TMPDIR/alltau.txt
  c3d $wbseg -as A $t1amy -interp NN -reslice-identity -push A  -lstat > $TMPDIR/allamy.txt
